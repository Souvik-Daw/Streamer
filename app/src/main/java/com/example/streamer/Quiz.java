...
import static com.example.streamer.Question.QuesToplayquiz;
...
public class Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customQuestion = (ArrayList<question>) getIntent().getSerializableExtra(Subject_TO_Question.stqToquiz);
        ...
        timer = new CountDownTimer(7800000,1000) {
            ...
            public void onFinish()
            {
                ...
                if (index+1 < customQuestion.size()) {
                    ...
                    Intent intent = new Intent(Quiz.this, Result2.class);
                    intent.putExtra("correct2", correctAnswers);
                    intent.putExtra("total2", customQuestion.size());
                    intent.putExtra("options", arr);
                    startActivity(intent);
                    Toast.makeText(Quiz.this, "Quiz Finished.", Toast.LENGTH_SHORT).show();
                }
