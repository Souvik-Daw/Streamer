...
public class Question extends AppCompatActivity {
    ...
    public static final String QuesToplayquiz = "QuesToplayquiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQueue = Volley.newRequestQueue(Question.this);
        start = findViewById(R.id.start);


        Intent intent = getIntent();
        category_id = intent.getStringExtra(Subject_OR_Question.SOQtoQ_cId);
        sub_category_id = intent.getStringExtra(Subject_OR_Question.SOQtoQ_ScId);
        subject_id = "0";

        jsonQuestionParse();

        //Toast.makeText(Question.this,category_id + "        " + sub_category_id,Toast.LENGTH_LONG).show();
            ...
            public void onResponse(JSONArray response) {
                try {
                    ...
                    if(customQuestion.size() == 0)
                    {
                        ...
                        Toast.makeText(Question.this, "Coming Soon", Toast.LENGTH_SHORT).show();
                    }
                        ...
                        start.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v) {
                                Intent in = new Intent(Question.this, playQuiz.class);
                                in.putExtra(QuesToplayquiz, customQuestion);
                                startActivity(in);
                            }
                        });
                    }
